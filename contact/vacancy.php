...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $emailMessage = '
        ...
        <body>
            ...
            <div id="footer">
                <p>Contact us at: saiyedkhan207@gmail.com | Visit our website: www.trendsxyz.com</p>
            </div>
        </body>
        </html>
    ';
    ...
    try {
        ...
        $mail->Password = ''; // Your SMTP password (Gmail password)
        $mail->SMTPSecure = 'ssl';
...
<div class="responsive-div">
    <div class="container mt-4">
        <div class="row">
            ...
            <br>
            <p class="h5-responsive" style="color:#444444;"><i style="color:#FFA500" class="fa fa-envelope"></i> saiyedkhan207@gmail.com
            </p>
            <br>
